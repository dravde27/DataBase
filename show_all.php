...
<?php
	...
	$select_all = 'SELECT `info_about_teacher`.teacher_id,
												`info_about_teacher`.full_name,
												`info_about_teacher`.date_of_birth,
												`info_about_teacher`.subjects,
												`info_about_teacher`.university,
												`salary_and_experience`.number_of_lessons_per_week,
                                                `salary_and_experience`.experience,
                                                `salary_and_experience`.salary_per_week_uah
								 FROM `info_about_teacher`
								 LEFT JOIN `salary_and_experience` 
								 ON `info_about_teacher`.teacher_id = `salary_and_experience`.teacher_id';
	
$special_select1 = ' SELECT `salary_and_experience`.teacher_id,
                            `info_about_teacher`.full_name, 
                            `salary_and_experience`.experience,
                            `salary_and_experience`.salary_per_week_uah
                                FROM `salary_and_experience` 
                                LEFT JOIN `info_about_teacher` 
								ON `salary_and_experience`.teacher_id = `info_about_teacher`.teacher_id  ORDER BY `salary_per_week_uah`	DESC 	
								';
$special_select2 = ' SELECT                     `info_about_teacher`.teacher_id,
												`info_about_teacher`.full_name,
												`info_about_teacher`.date_of_birth,
  (
...
$special_select3 = ' SELECT `salary_and_experience`.teacher_id,
                            `info_about_teacher`.full_name, 
                            `salary_and_experience`.number_of_lessons_per_week
                                FROM `salary_and_experience`
                                LEFT JOIN `info_about_teacher` 
								ON `salary_and_experience`.teacher_id = `info_about_teacher`.teacher_id 
